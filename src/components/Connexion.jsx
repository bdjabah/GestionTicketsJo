...
export default function Connexion() {
    ...
    return (
        <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-[#f4ede4]">
            ...
            <div className="relative flex flex-col justify-center items-center p-8">
                ...
                <button
                    onClick={() => navigate(-1)}
                    className="absolute top-6 left-6 bg-[#d9c275] rounded-full w-10 h-10 flex items-center justify-center text-xl"
                >
                    ←
                </button>
                ...
                <div className="w-full max-w-sm bg-white p-6 rounded shadow-md">
                    ...
                    <input
                        ...
                        className="w-full p-2 border rounded mb-4"
                    />
                    <button className="w-full bg-[#d9c275] text-white py-2 rounded hover:opacity-90 transition">
                        Je me connecte
                    </button>
                </div>
